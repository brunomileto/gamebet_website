from gamebet_website.app.mod_tables.serverside.serverside_table import ServerSideTable
from gamebet_website.app.mod_tables.serverside import table_schemas
